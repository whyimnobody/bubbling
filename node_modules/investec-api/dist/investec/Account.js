...
class Account {
    ...
    getBalance() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const balance = yield (0, investec_1.getAccountBalance)(this.client.token.access_token, this.accountId);
    ...
    getTransactions({ fromDate, toDate, transactionType, }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const transactions = yield (0, investec_1.getInvestecTransactionsForAccount)(this.client.token.access_token, { accountId: this.accountId, fromDate, toDate, transactionType });
